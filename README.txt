...
Also plone.app.layout.navigation.interfaces.INavigationRoot is protected by default (used for language folders such as it, en, etc) as well as IProtectDelete.
